...
public class StaffServiceImpl implements StaffService {
    ...
    @Override
    public List<ReportResDTO> getStaffReports(Long staffId, String fromDate, String toDate, Boolean isResolved, Integer pageSize, Integer pageNo) {
        ...
        List<Report> reports = em.createQuery(cq).setFirstResult(pageNo * pageSize).setMaxResults(pageSize).getResultList();
